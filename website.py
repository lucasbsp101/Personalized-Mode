...
@app.route('/page_3_7')
def page_3_7():
    return render_template('page_3_7.html', page_num=7, num_pages=9, content="Conteúdo sobre Image Segmentation Architectures")
...
def course_topic(topic_num):
    ...
    if topic_num in page_content:
        ...
        return render_template(template_data['template'], page_num=topic_num, num_pages=len(page_content), content=template_data['content'])
    else:
